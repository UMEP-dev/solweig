...
## Summary — v0.1.0b94 (2026-08-25)

Baseline numbers are identical to b89. b90 added the opt-in 2026a ground
scheme with defaults off. b91 reduced large-raster memory use. b93 and
b94 are bug-fix releases with no numerical change (b93: QGIS plugin
...
positioning). b92 was performance and GPU-utilisation work: async and overlapped I/O (tiled writes,
