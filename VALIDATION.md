...
## Summary — v0.1.0b93 (2026-08-24)

Baseline numbers are identical to b89. b90 added the opt-in 2026a ground
scheme with defaults off. b91 reduced large-raster memory use. b93 is a
bug-fix release with no numerical change: the QGIS plugin metadata parse
failure and stale-SVF-cache detection at load time. b92 was
performance and GPU-utilisation work: async and overlapped I/O (tiled writes,
